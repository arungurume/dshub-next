    ...
    <div className="playlists-page">
      ...
      <div className="toolbar">
        ...
        <div className="toolbar-right">
          ...
          <button className="btn-primary" onClick={() => router.push('/admin/playlists/create')} id="create-playlist-btn">
      ...
      {loading ? (
        ...
        <div className="page-empty">
          ...
          <button className="btn-primary" onClick={() => router.push('/admin/playlists/create')} id="empty-create-playlist">
          ...
          {playlists.map(pl => (
            ...
            >
              ...
              <div className="pl-actions">
                <button className="pl-btn" onClick={() => router.push(`/admin/playlists/${pl.id}`)} title="Edit" id={`edit-${pl.id}`}>
                  <Pencil size={13} /> Edit
                </button>
