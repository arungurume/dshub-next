          ...
          {activeTab === 'organization' && (
            <div className="admin-controls-strip">
              <div className="admin-control-card">
                ...
                <button className="btn-outline-sm" onClick={() => router.push('/admin/users')} id="manage-team-btn">{t('MY_ACCOUNT.manage')}</button>
              </div>
              <div className="admin-control-card">
                <Monitor size={18} />
                <div>
                ...
                <button className="btn-outline-sm" onClick={() => router.push('/admin/locations')} id="manage-locations-btn">{t('MY_ACCOUNT.manage')}</button>
              </div>
            </div>
          )}
            ...
            <div className="account-form">
              ...
              {activeBillingTab === 'usage' && (
                <div className="billing-usage">
                  <div className="plan-summary-card">
                    ...
                    <button className="btn-primary btn-sm-inline" onClick={() => router.push('/admin/billing')} id="manage-plan-btn">
              ...
              {activeBillingTab === 'invoices' && (
                <div className="billing-empty"><Receipt size={32} opacity={.2} /><p>{t('MY_ACCOUNT.invoices_portal')}</p>
                  <button className="btn-primary btn-sm-inline" onClick={() => router.push('/admin/billing')} id="open-billing-portal-btn"><ExternalLink size={14} /> {t('MY_ACCOUNT.open_billing')}</button>
                </div>
              )}
            </div>
          )}
