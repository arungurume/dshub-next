    ...
    <div className="tag-detail-page">
      ...
      <div className="toolbar">
        <div className="toolbar-left">
          <button className="back-btn" onClick={() => router.push('/admin/screens/tags')} id="back-to-tags">
            <ArrowLeft size={16} />
          </button>
        ...
        <div className="screens-panel">
          ...
          {screens.length === 0 ? (
            <div className="screens-empty">
              ...
              <button className="btn-secondary" onClick={() => router.push('/admin/screens')} id="empty-view-screens">
