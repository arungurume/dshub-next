...
function UpgradeBanner({ used, total, t }: { used: number; total: number; t: (k: string) => string }) {
  ...
  return (
    <div className="upgrade-banner">
      ...
      <a href="/admin/billing" className="upgrade-link" id="upgrade-link">{t('SCREENS.upgrade_plan')}</a>
    </div>
  );
}
    ...
    try {
      if (search.trim()) {
        ...
        if (!data.content?.length && page === 0) {
          router.push('/admin/screens/no-paired');
          return;
        }
    ...
    <div className="screens-page">
      ...
      <div className="toolbar">
        ...
        <div className="toolbar-right">
          ...
          <button
            ...
            onClick={() => router.push('/admin/screens/tags')}
            id="manage-tags-btn"
          >
      ...
      {loading ? (
        ...
        <div className="page-empty">
          ...
          <button className="btn-primary" onClick={() => router.push('/admin/screens/new')} id="empty-pair-screen">
                  ...
                  <td>
                    <div className="action-row">
                      <button
                        ...
                        onClick={() => router.push(`/admin/screens/edit/${screen.id}`)}
                        title="Edit"
